...
# classifications, reports etc.
OUTPUT_PATH = "output"

MODEL_PATH = path.sep.join([OUTPUT_PATH, "resnet_imagenet.hdf5"])
FIG_PATH = path.sep.join([OUTPUT_PATH, "resnet_imagenet.png"])
JSON_PATH = path.sep.join([OUTPUT_PATH, "resnet_imagenet.json"])
