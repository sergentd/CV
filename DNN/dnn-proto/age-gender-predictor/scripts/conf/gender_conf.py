...
# define the mean pixel intensity file
MEAN_NAME = "gender_adience_mean.json"
DATASET_MEAN_PATH = path.sep.join([OUTPUT_DIR, MEAN_NAME])

# define the gender filenames
TRAIN_LST_NAME = "gender_train.lst"
VAL_LST_NAME   = "gender_val.lst"
TEST_LST_NAME  = "gender_test.lst"
TRAIN_REC_NAME = "gender_train.rec"
VAL_REC_NAME   = "gender_val.rec"
TEST_REC_NAME  = "gender_test.rec"
...
NUM_CLASSES = 2
LABEL_ENCODER_PATH = path.sep.join([OUTPUT_DIR, "gender_le.pickle"])
