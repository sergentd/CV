...
# 	/raid/datasets/cars/rec/train.rec resize=256 encoding='.jpg' quality=100
# ~/mxnet/bin/im2rec /raid/datasets/cars/lists/val.lst "" \
# 	/raid/datasets/cars/rec/val.rec resize=256 encoding='.jpg' quality=100
# ~/mxnet/bin/im2rec /raid/datasets/cars/lists/test.lst "" \
# 	/raid/datasets/cars/rec/test.rec resize=256 encoding='.jpg' quality=100
