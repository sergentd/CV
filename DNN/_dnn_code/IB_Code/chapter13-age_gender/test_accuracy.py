# USAGE
# python test_accuracy.py --checkpoints checkpoints/gender_checkpoints --prefix gendernet --epoch 110
# python test_accuracy.py --checkpoints checkpoints/age_checkpoints --prefix agenet --epoch 150
