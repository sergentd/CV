...
class MxVGGNet:
    ...
    def build(classes):
        ...
        conv3_1 = mx.sym.Convolution(data=do2, kernel=(3,3), pad=(1,1),
            num_filters=256, name="conv3_1")
        act3_1 = mx.sym.LeakyReLU(data=conv3_1, act_type="prelu",
            name="act3_1")
        bn3_1 = mx.sym.BatchNorm(data=act3_1, name="bn3_1")
        conv3_2 = mx.sym.Convolution(data=bn2_1, kernel=(3, 3), pad=(1,1),
            num_filters=256, name="conv3_2")
