...
class FeatureIndexer(BaseIndexer):
    def __init__(self, dbPath, estNumImages=500, maxBufferSize=50000, dbResizeFactor=2,
        ...
        # open the HDF5 database for writting and initialize the datasets within the group
        ...
        # initialize the total number of features in the bugger along with the
        # indexes dictionnary
    ...
    def add(self, imageID, kps, features):
        ...
        # check to see if the maximum buffer size is reached
